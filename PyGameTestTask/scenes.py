...
def create_main_scene():
    ...
    game_timer_behaviour = GameTimer(20, game_timer_renderer)
    ...
    return Scene([player_object, asteroid_spawner_object, score_object, game_timer_object, game_manager_object])
